...
Begin VB.Form frmUtama 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdStop 
         ...
         Height          =   855
         Left            =   960
         MouseIcon       =   "form.frx":074C
         MousePointer    =   99  'Custom
         Picture         =   "form.frx":0A56
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   240
         Width           =   735
      ...
      Begin VB.CommandButton cmdRun 
         ...
         Height          =   855
         Left            =   120
         MouseIcon       =   "form.frx":0E98
         MousePointer    =   99  'Custom
         Picture         =   "form.frx":11A2
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   240
         Width           =   735
   ...
   Begin VB.Label CreateByCanGreDiMi 
      ...
      BackColor       =   &H00FF0000&
      BackStyle       =   0  'Transparent
      Caption         =   "Created By Candra.Azmi.Gregorius.Edi"
      Height          =   615
      Left            =   1080
      TabIndex        =   45
      Top             =   6480
